...
const Contact = () => {
  ...
  const sendEmail = (e) => {
    ...
    emailjs
      .sendForm(
        "service_xxoimp5",  // Replace with your EmailJS Service ID
        "template_je3b5fo",  // Replace with your EmailJS Template ID
        form.current,
        "roxRHJzpn-AwaSOb4"  // Replace with your EmailJS Public Key
      )
      .then(
        () => {
          setIsSent(true);
